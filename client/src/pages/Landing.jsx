        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <span className="block text-[10px] text-cyan-400 tracking-wider font-mono">
                ECO-SIMULATOR
              </span>
            </div>
          </Link>
          ...
          <nav className="flex items-center gap-4">
            {user ? (
              <>
                <Link
                  to="/dashboard"
                  className="btn-premium-secondary py-2 px-5 text-sm"
                >
                  Go to Dashboard
                </Link>
                <button
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="btn-premium-cta py-2 px-5 text-sm font-bold"
                >
                  Claim Twin
                </Link>
              </>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-20 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-6 space-y-6">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-green-300"
            >
            ...
            >
              ...
              city and witness your collective impact shape its environment in
              real-time.
            </motion.p>
        ...
        <section className="py-24 border-t border-white/5 mt-16">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="text-xs uppercase font-extrabold tracking-widest text-cyan-400">
              App Capabilities
            </h2>
            ...
            <p className="text-gray-400">
              Our suite of 3D and AI tools creates a gorgeous, unified loop that
              tracks your real habits and projects their future consequences.
            </p>
          </div>
        ...
        <section className="mt-12">
          ...
          >
            ...
            <div className="pt-4 relative z-10">
              <Link
                to={user ? "/dashboard" : "/register"}
                className="btn-premium-cta inline-flex items-center gap-3"
              >
